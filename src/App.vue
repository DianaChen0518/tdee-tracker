...
<template>
  <div class="p-4 md:p-6 flex justify-center w-full">
    <div class="w-full max-w-[1400px]">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="bg-[#1e1e1e] p-6 rounded-2xl border border-[#333] h-full flex flex-col">
          <h2 class="text-lg font-bold mb-4">🍽️ 饮食摄入</h2>
          <div class="flex flex-wrap gap-2 mb-4 bg-[#252525] p-3 rounded-xl border border-[#333]">
            ...
            <div class="flex gap-2 w-full mt-2">
              <button @click="addFood" class="bg-blue-600 hover:bg-blue-500 flex-1 py-2 rounded-lg text-xs font-bold">吃下肚</button>
              <button @click="saveQuickFood" class="bg-purple-600 hover:bg-purple-500 flex-1 py-2 rounded-lg text-xs font-bold">存快捷</button>
            </div>
          </div>
          ...
          <div class="flex-1 border-t border-[#333] pt-4 flex flex-col min-h-[200px]">
            <h3 class="text-xs text-gray-400 mb-3">当日已摄入：</h3>
        ...
        <!-- 右侧：数据大盘 -->
        <div class="space-y-6">
          <div class="bg-[#183321] p-5 rounded-2xl border border-[#1f5030]">
            ...
            <div class="bg-[#121212] p-3 rounded-xl border border-[#333] text-center">
              <div class="text-xs text-gray-400 mb-1">当日热量缺口</div>
              <div :class="['text-3xl font-black mb-1', store.dailyDeficit > 0 ? 'text-blue-400' : 'text-red-400']">
          ...
          <div class="bg-[#1e1e1e] p-5 rounded-2xl border border-[#333]">
